(function() {
    ...
    var chatData = {
        ...
        unknown: 'ممكن أساعدك في:\n\n• معرفة خدماتنا (تصميم جرافيك، مونتاج، سوشيال ميديا)\n• الأسعار والباقات\n• مواعيد التسليم\n• طرق الدفع\n• طرق التواصل معنا\n\nأو اكتب سؤالك وهجاوبك! 😊',
        fallback: 'مش فاهم سؤالك تمام. ممكن تسأل عن:\n\n• خدماتنا وأسعارنا\n• مواعيد التسليم\n• طرق الدفع\n• التواصل معنا\n\nأو كلمنا مباشرة على الواتساب: +201556152510'
    };
    ...
    function getResponse(input) {
        ...
        // Contact
        if (/\b(تواصل|اتصال|رقم|واتساب|ايميل|بريد|هاتف|contact|Call|Phone|Email)\b/.test(lower)) {
